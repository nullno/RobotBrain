...
class AngleKnob(FloatLayout):
    value = NumericProperty(0.0)
    display_value = NumericProperty(0.0)

    def __init__(self, **kwargs):
        kwargs.setdefault("size_hint", (None, None))
        kwargs.setdefault("size", (dp(180), dp(180)))
        ...
        self.bind(pos=self._update_canvas, size=self._update_canvas, display_value=self._update_canvas)
    ...
    def _update_canvas(self, *args):
        ...
        progress_pts = []
        val = max(0.0, min(360.0, float(self.display_value)))
        if val <= 0.0:
        ...
        canvas_deg = self._angle_to_canvas(self.display_value)
        ...
        self._value_label.text = f"{int(round(self.display_value))}°"
    ...
    def set_value(self, value):
        try:
            ...
            value = 0.0
        self.value = max(0.0, min(360.0, value))
    ...
    def _update_from_touch(self, touch):
        ...
        self.set_value(float(self.value) + float(delta))
        self._drag_last_raw = raw
